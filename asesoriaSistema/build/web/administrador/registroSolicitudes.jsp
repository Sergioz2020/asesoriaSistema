                    ...
                    <tbody>
                        <c:forEach var = "solicitud" items="${solicitudes}">
                            <tr> 
                                ...
                                <td>${solicitud.getNombre_solicitante()}</td>
                                <td>${solicitud.getInstitucion()}</td>
                                <td>${solicitud.getTelefono()}</td>
                                <td>${solicitud.getEmail()}</td>


                                <td>
                                    <a class="btn btn-warning" href="Controlador?accion=registroAsesorias&action=Editar&id=${solicitud.getId()}">Modificar</a>
                                    <a class="btn btn-danger" href="Controlador?accion=registroAsesorias&action=Eliminar&id=${solicitud.getId()}">Eliminar</a>
