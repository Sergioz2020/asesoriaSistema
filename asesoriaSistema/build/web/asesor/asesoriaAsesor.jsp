        ...
        <div class="d-flex">
            <div class="card col-sm-4">
                <div class ="card-body">
                    ...
                    <form action="Controlador?accion=asesoriaAsesor" method="POST">
                        ...
                        <div class ="form-group">
                            ...
                            <input type="text" required value="${asesoria.getDescripcion()} "name="txtDescripcion" class="form-control">
                                     ...
                                     <div class ="form-group">
                            <label>Enlace </label>
                            <input type="text" required value="${asesoria.getEnlace()} "name="txtEnlace" class="form-control">
                        ...
                        <c:forEach var = "asesoria" items="${asesorias}">
                            <tr> 
                                ...
                                <td>${asesoria.getNombre_asesor()}</td>
                                 <td>${asesoria.getEnlace()}</td>

                                <td>
                                    <a class="btn btn-warning" href="Controlador?accion=asesoriaAsesor&action=Editar&id_editar=${asesoria.getId()}">Modificar</a>
                                    <a class="btn btn-danger" href="Controlador?accion=asesoriaAsesor&action=Eliminar&id_eliminar=${asesoria.getId()}">Eliminar</a>
